...
-- 3.3 (opcional, mas recomendado) for�ar que o sa n�o expire
...
-- 4.2 criar um login dedicado (evita usar sa em produ��o)
...
-- 4.3 criar usu�rio no banco e dar permiss�es
